...
const About = () => {
  ...
  const values = [
    {
      title: 'Innovation',
      description: 'Constantly evolving to deliver the best technology',
      icon: Lightbulb,
    },
    {
      title: 'Integrity',
      description: 'Building systems and relationships that clients can trust',
      icon: Shield,
    },
    {
      title: 'Accessibility',
      description: 'Making advanced tools available to every business',
      icon: Heart,
    },
    {
      title: 'Partnership',
      description: 'Working alongside clients as a trusted ally in growth',
      icon: Handshake,
    },
  ]
        ...
        <div className="container mx-auto px-6 py-16">
          ...
          <div className="text-center mb-16">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              <span className="bg-gradient-cyber bg-clip-text text-transparent">
                About Dolonia Data Tech
              </span>
            </h1>
            <p className="text-xl text-cyan-soft max-w-3xl mx-auto mb-12">
              Technology solutions company focused on creating secure, reliable, and future-ready
              digital systems that help businesses grow and operate with confidence.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
            {stats.map((stat, index) => (
              <Card
                key={index}
                className="bg-ocean-surface/50 border-ocean-surface backdrop-blur-sm text-center group hover:bg-ocean-surface/70 transition-all duration-300"
              >
                <CardHeader className="pb-2">
                  ...
                  <CardTitle className="text-2xl font-bold text-cyan-bright">
                    {stat.value}
                  </CardTitle>
                </CardHeader>
                <CardContent>
            ...
            <Card className="bg-ocean-surface/30 border-ocean-surface backdrop-blur-sm">
              ...
              <CardContent>
                <p className="text-cyan-soft text-lg leading-relaxed text-center">
                  Dolonia Data Tech is a technology solutions company based in Oklahoma City,
                  Oklahoma. We focus on creating
                  <strong className="text-cyan-bright">
                    {' '}
                    secure, reliable, and future-ready digital systems
                  </strong>{' '}
                  that help businesses grow and operate with confidence. From custom websites and
                  hosting to automation, intelligent assistants, and business consulting, we design
                  tools that make technology simple and effective.
                </p>
              </CardContent>
            </Card>
          </div>
            ...
            <Card className="bg-ocean-surface/30 border-ocean-surface backdrop-blur-sm">
              ...
              <CardContent className="space-y-4">
                <p className="text-cyan-soft text-lg leading-relaxed">
                  Dolonia Data Tech was built with a clear goal: to give businesses the same
                  high-level technology that large enterprises use, but in a way that's
                  <strong className="text-cyan-bright">
                    {' '}
                    accessible, affordable, and easy to understand
                  </strong>
                  .
                </p>
                <p className="text-cyan-soft text-lg leading-relaxed">
                  What started as a vision to combine{' '}
                  <strong className="text-cyan-bright">
                    design, automation, and secure hosting
                  </strong>{' '}
                  has grown into a company trusted to deliver
                  <strong className="text-cyan-bright"> scalable solutions</strong> that meet the
                  demands of a fast-changing digital world.
                </p>
                <p className="text-cyan-soft text-lg leading-relaxed">
                  We understand the challenges small businesses and startups face — limited
                  resources, growing demands, and the need to stay competitive. That's why we've
            ...
            <Card className="bg-ocean-surface/30 border-ocean-surface backdrop-blur-sm">
              ...
              <CardContent>
                <p className="text-cyan-soft text-lg leading-relaxed mb-4">
                  Our mission is to{' '}
                  <strong className="text-cyan-bright">simplify complex technology</strong> and give
                  every business the tools to:
                </p>
                ...
                <p className="text-cyan-soft text-lg leading-relaxed mt-4">
                  We don't just build systems — we build{' '}
                  <strong className="text-cyan-bright">pathways to growth and independence</strong>.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-ocean-surface/30 border-ocean-surface backdrop-blur-sm">
              ...
              <CardContent>
                <p className="text-cyan-soft text-lg leading-relaxed mb-4">
                  ...
                  <strong className="text-cyan-bright">
                    national leader in business technology solutions
                  </strong>
                  , recognized for making advanced digital systems simple, secure, and sustainable.
                </p>
                <p className="text-cyan-soft text-lg leading-relaxed">
                  We see a future where businesses of all sizes can access{' '}
                  <strong className="text-cyan-bright">
                    enterprise-level tools without enterprise-level headaches
                  </strong>
                  , where technology becomes a{' '}
                  <strong className="text-cyan-bright">driver of growth and creativity</strong>{' '}
                  instead of a burden.
                </p>
              </CardContent>
            </Card>
              ...
              {values.map((value, index) => (
                ...
                >
                  <CardHeader className="pb-2">
                    ...
                    <CardTitle className="text-xl font-bold text-cyan-bright">
                      {value.title}
                    </CardTitle>
                  </CardHeader>
                  <CardContent>
          ...
          <div className="max-w-4xl mx-auto">
            <Card className="bg-ocean-surface/30 border-ocean-surface backdrop-blur-sm">
              ...
              <CardContent className="text-center space-y-6">
                <p className="text-cyan-soft text-lg leading-relaxed">
                  At Dolonia Data Tech, we're more than just a service provider — we're your{' '}
                  <strong className="text-cyan-bright">partner in digital growth</strong>. Whether
                  you're a startup building your first website, or a company ready to scale with
                  automation and strategy, we're here to make it happen.
                </p>
