    ...
    services: [
      {
        ...
        description:
          'Professional, responsive websites built for your brand with a focus on user experience and performance.',
        pricing: [
          ...
          { tier: 'Business', price: '$3,500 – $5,000' },
          {
            tier: 'Advanced',
            price: '$7,500+',
            note: 'custom integrations, dashboards, client portals',
          },
        ],
      },
      {
        ...
        pricing: [{ tier: 'Standard', price: '$1,000 – $3,500', note: 'depending on scope' }],
      },
      {
        name: 'Web Hosting & Storage Services',
        description:
          'Secure hosting solutions with built-in storage and regular updates to keep your website running smoothly.',
        pricing: [
          { tier: 'Hosting Only', price: '$50 – $100/month' },
          {
            tier: 'Full Service',
            price: '$250 – $500/month',
            note: 'hosting + security + updates',
          },
        ],
      },
    ],
    ...
    services: [
      {
        ...
        description:
          'Streamline repetitive tasks such as emails, client intake, and data management with automated systems.',
        pricing: [
      ...
      },
      {
        ...
        description:
          'Professional resumes, cover letters, and job application support powered by advanced AI tools.',
        pricing: [
      ...
      },
      {
        ...
        description:
          'Custom chat assistants for websites or community platforms to help with customer support and engagement.',
        pricing: [
    ...
    services: [
      {
        ...
        description:
          'Mini-database systems that give your business private hosting, data storage, and secure access.',
        pricing: [
      ...
      },
      {
        ...
        description:
          'Comprehensive audits to find weaknesses in your system and provide solutions for stronger protection.',
        pricing: [
      ...
      },
      {
        ...
        description:
          'Complete setup for offices or teams, including networking, devices, and secure systems to keep operations running smoothly.',
        pricing: [
    ...
    services: [
      {
        ...
        description:
          'Professional business plans tailored for SBA requirements, grants, and investors.',
        pricing: [
      ...
      },
      {
        ...
        description:
          'Polished, professional pitch decks that help secure funding and partnerships.',
        pricing: [
      ...
      },
      {
        ...
        description:
          'Guidance on how to integrate digital systems, automation, and secure technology into your business.',
        pricing: [
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-cyan-soft max-w-3xl mx-auto leading-relaxed">
            Comprehensive pricing for all our technology, automation, and digital solutions. All
            services can be bundled or included in retainer packages.
          </p>
        </div>
                      ...
                      <CardContent>
                        <div className="space-y-3">
                          {service.pricing.map((pricing, pricingIndex) => (
                            <div
                              key={pricingIndex}
                              className="flex items-center justify-between p-3 bg-ocean-surface/40 rounded-lg"
                            >
                              <div className="flex items-center space-x-3">
                                <Badge
                                  variant="outline"
                                  className="text-cyan-bright border-cyan-bright/50"
                                >
                                  {pricing.tier}
                                </Badge>
                                {pricing.note && (
