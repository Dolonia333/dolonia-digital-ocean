...
const InteractiveDemo: React.FC = () => {
  ...
  const getStatusIcon = (
    ...
    if (status === 'running')
      return <IconComponent className="w-6 h-6 text-cyan-bright animate-pulse" />
            ...
            <Card className="mt-8 bg-gradient-cyber/10 backdrop-blur-sm border-cyan-bright animate-fade-in">
              ...
              <CardContent className="text-center">
                <p className="text-cyan-soft mb-6">
                  Your cloud infrastructure has been deployed with enterprise-grade security and AI
                  optimization.
                </p>
