        ...
        <div className="container mx-auto px-6 py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            <Card className="bg-ocean-surface/30 border-ocean-surface backdrop-blur-sm">
              ...
              <CardContent>
                <p className="text-cyan-soft mb-4">Streamline operations with intelligent automation solutions.</p>
            ...
            <Card className="bg-ocean-surface/30 border-ocean-surface backdrop-blur-sm">
              ...
              <CardContent>
                <p className="text-cyan-soft mb-4">Enterprise-grade security and compliance solutions.</p>
                <ul className="text-cyan-soft space-y-2">
            ...
            <Card className="bg-ocean-surface/30 border-ocean-surface backdrop-blur-sm">
              ...
              <CardContent>
                <p className="text-cyan-soft mb-4">Scalable cloud solutions and infrastructure management.</p>
                <ul className="text-cyan-soft space-y-2">
            ...
            <Card className="bg-ocean-surface/30 border-ocean-surface backdrop-blur-sm">
              ...
              <CardContent>
                <p className="text-cyan-soft mb-4">Custom development and system integration services.</p>
                <ul className="text-cyan-soft space-y-2">
          ...
          <Card className="bg-ocean-surface/30 border-ocean-surface backdrop-blur-sm max-w-4xl mx-auto">
            ...
            <CardContent className="text-center">
              <p className="text-cyan-soft mb-6">
                ...
                please contact us directly. We provide tailored solutions for every business size and industry.
              </p>
