          ...
          <Card className="max-w-4xl mx-auto bg-ocean-surface/50 backdrop-blur-sm border-ocean-surface">
            ...
            <CardContent className="space-y-6 text-cyan-soft">
              <div>
                ...
                <p>We collect information you provide when contacting us, including your name, email address, company, and message content.</p>
              </div>

              <div>
                <h3 className="text-lg font-semibold text-cyan-bright mb-2">Newsletter Subscriptions</h3>
                <p>When you subscribe to our newsletter, we collect your email address to send you updates about our services and industry insights.</p>
              </div>

              <div>
                <h3 className="text-lg font-semibold text-cyan-bright mb-2">Usage Data</h3>
                <p>We may collect information about how you interact with our website to improve our services and user experience.</p>
              </div>

              <div>
                <h3 className="text-lg font-semibold text-cyan-bright mb-2">How We Use Your Information</h3>
              ...
              <div>
                ...
                <p>If you have questions about this Privacy Policy, please contact us at <a href="mailto:zion@royalsocietymanagement.com" className="text-cyan-bright hover:underline">zion@royalsocietymanagement.com</a></p>
              </div>
