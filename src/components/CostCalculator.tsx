...
const CostCalculator: React.FC = () => {
  ...
  const handleGetStartedWithConfig = () => {
    ...
    localStorage.setItem('dolonia-calculator-config', JSON.stringify({
      config,
      costs,
  ...
  const handleScheduleConsultation = () => {
    ...
    localStorage.setItem('dolonia-consultation-config', JSON.stringify({
      config,
      costs,
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-cyan-soft max-w-3xl mx-auto">
            Estimate your monthly costs and discover potential savings with
            Dolonia
          </p>
        </div>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <Slider
                    ...
                    onValueChange={(value) =>
                      handleConfigChange("servers", value[0])
                    }
                    max={20}
                    min={1}
                    step={1}
                ...
                <div className="space-y-3">
                  ...
                  <Slider
                    ...
                    onValueChange={(value) =>
                      handleConfigChange("storage", value[0])
                    }
                    max={5000}
                    min={50}
                    step={50}
                ...
                <div className="space-y-3">
                  ...
                  <Slider
                    ...
                    onValueChange={(value) =>
                      handleConfigChange("bandwidth", value[0])
                    }
                    max={10000}
                    min={100}
                    step={100}
                ...
                <div className="space-y-3">
                  ...
                  <Input
                    ...
                    value={config.users}
                    onChange={(e) =>
                      handleConfigChange("users", parseInt(e.target.value) || 0)
                    }
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    {["basic", "standard", "enterprise"].map((level) => (
                      <Button
                        key={level}
                        variant={
                          config.securityLevel === level ? "default" : "outline"
                        }
                        size="sm"
                        onClick={() =>
                          handleConfigChange("securityLevel", level)
                        }
                        className={
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Button
                      ...
                      size="sm"
                      onClick={() =>
                        handleConfigChange("multiCloud", !config.multiCloud)
                      }
                      className={
                        config.multiCloud
                          ? "bg-gradient-cyber text-ocean-deep"
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-foreground font-medium">
                      ${costs.storage.toFixed(2)}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-cyan-soft">
                      Bandwidth ({config.bandwidth} GB)
                    </span>
                    <span className="text-foreground font-medium">
                  ...
                  <div className="flex justify-between">
                    <span className="text-cyan-soft flex items-center space-x-2">
                      <span>Security</span>
                      <Badge
                        className={`text-xs ${getSecurityBadgeColor(
                  ...
                  <div className="bg-green-400/10 border border-green-400/30 rounded-lg p-4 mt-4">
                    ...
                    <p className="text-sm text-cyan-soft">
                      ...
                      <strong className="text-green-400">
                        ${costs.savings.toFixed(2)}/month
                      </strong>{" "}
                      through intelligent resource management and automated
                      scaling.
                    </p>
