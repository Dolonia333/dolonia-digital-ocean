...
const CostCalculator: React.FC = () => {
  ...
  const calculateCosts = useCallback(() => {
    ...
    switch (config.securityLevel) {
      ...
      case 'standard': securityCost = 99; break;
      case 'enterprise': securityCost = 299; break;
    }
  ...
  const getSecurityBadgeColor = (level: string) => {
    switch (level) {
      case 'basic': return 'bg-yellow-400/20 text-yellow-400';
      case 'standard': return 'bg-cyan-400/20 text-cyan-400';
      case 'enterprise': return 'bg-green-400/20 text-green-400';
      default: return 'bg-cyan-400/20 text-cyan-400';
    }
  };
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    {['basic', 'standard', 'enterprise'].map((level) => (
                      <Button
                        ...
                        className={config.securityLevel === level 
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <Button
                      ...
                      className={config.aiOptimization 
                        ? 'bg-gradient-cyber text-ocean-deep' 
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-foreground font-medium">${costs.bandwidth.toFixed(2)}</span>
                  </div>
                  <div className="flex justify-between">
                ...
                {costs.savings > 0 && (
                  <div className="bg-green-400/10 border border-green-400/30 rounded-lg p-4 mt-4">
                    ...
                    <p className="text-sm text-cyan-soft">
                      Our AI optimization can save you <strong className="text-green-400">${costs.savings.toFixed(2)}/month</strong> through intelligent resource management and automated scaling.
                    </p>
                ...
                <div className="pt-4 space-y-3">
                  <Button className="w-full bg-gradient-cyber hover:shadow-glow text-ocean-deep font-semibold transition-all duration-300">
